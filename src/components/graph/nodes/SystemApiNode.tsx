...
export const SystemApiNode: React.FC<{ name?: string; health?: number }> = ({
  name,
  health,
}) => (
  <div
    className={clsx(
      ...
      "bg-gray-100 border-2 border-gray-300 rounded-lg shadow p-1 min-w-[90px] max-w-[120px]"
    )}
  >
    <Cloud className="h-6 w-6 text-gray-700 mb-0.5" />
